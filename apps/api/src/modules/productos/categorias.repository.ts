...
export interface CategoriasRepository {
  crear(input: CrearCategoriaInput): Promise<CategoriaRecord>;
  actualizar(empresaId: string, id: string, input: ActualizarCategoriaInput): Promise<CategoriaRecord | null>;
