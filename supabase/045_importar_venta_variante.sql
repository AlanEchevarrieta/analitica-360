-- Importación masiva de ventas: respeta variante_id en cada ítem.
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO public.movimientos_inventario (
      ...
      costo_unitario, precio_unitario, motivo, referencia_id, fecha, variante_id
    ) VALUES (
      v_empresa, v_producto, v_user, 'venta', v_cantidad, -1,
      v_costo, v_precio, 'Venta importada', v_venta, v_fecha, v_variante
    );
  END LOOP;
