  ...
  return (
    <div className="relative min-h-dvh bg-canvas">
      ...
      <div className="relative z-10 flex min-h-dvh items-center justify-center px-5 py-10">
        <div
          className="auth-card flex w-full min-h-0 max-w-[440px] flex-col rounded-lg bg-white/95 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-md md:min-h-[820px] md:p-10"
          style={{ fontFamily: 'Inter, system-ui, sans-serif', width: 'min(440px, 90%)' }}
        >
